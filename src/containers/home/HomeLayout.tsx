      ...
      <Container maxW="1200px">
        ...
        <Tabs index={page} isLazy lazyBehavior="keepMounted">
          ...
          <Grid display="grid" gridTemplateColumns="3fr 2fr" gap="24px">
            <TabPanels>
              <TabPanel>
                <RequisitionForm handleTab={handlePage} requisitionDetails={requisitionDetails} />
              </TabPanel>
              <TabPanel>
                <JobDetailsForm handleTab={handlePage} jobDetails={jobDetails} />
              </TabPanel>
              <TabPanel>
                <InterviewSettingsForm handleTab={handlePage}interviewSettings={interviewSettings}/>
              </TabPanel>
            </TabPanels>
